...
theFilter = load(fullfile(getpref('OneLightToolbox', 'OneLightCalData'),'xNDFilters',filterFile));
...
% Save
SaveCalFile(calOut, calOut.describe.calType.CalFileName, fullfile(getpref('OneLightToolbox', 'OneLightCalData')));