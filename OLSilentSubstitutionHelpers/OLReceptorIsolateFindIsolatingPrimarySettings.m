...
if cacheExists && ~forceRecompute
    ...
    for observerAgeInYears = [20:60];
        ...
        [T_cones, T_quantalIsom]  = GetHumanPhotoreceptorSS(S, {'LCone' 'MCone' 'SCone'}, params.fieldSizeDegrees, observerAgeInYears, pupilDiameterMm, lambdaMaxShift, []);
        [T_conesHemo, T_quantalIsomHemo]  = GetHumanPhotoreceptorSS(S, {'LConeHemoLegacy' 'MConeHemoLegacy' 'SConeHemoLegacy'}, params.fieldSizeDegrees, observerAgeInYears, pupilDiameterMm, lambdaMaxShift, []);
