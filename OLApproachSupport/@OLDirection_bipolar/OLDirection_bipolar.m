classdef OLDirection_bipolar < OLDirection
    ...
    methods
        function this = OLDirection_bipolar(differentialPositive, differentialNegative, calibration, varargin)
            ...
            parser.addOptional('describe',struct('createdFrom',struct('constructor','construtor','arguments',{{differentialPositive,differentialNegative,calibration,varargin}}),'correction',[],'validation',[]),@isstruct);
