...
% Obtain correction params from OLCorrectionParamsDictionary, according to
% the boxName specified in protocolParams.boxName
...
for d = 1:length(theDirections)
    ...
    [cacheData, olCache, spectroRadiometerOBJ, cal] = OLCorrectCacheFileOOC(...
        ...
        'simulate',                     correctionParams.simulate, ...
        'approach',                     correctionParams.approach);
