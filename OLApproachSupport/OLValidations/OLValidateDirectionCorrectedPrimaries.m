...
d = OLCorrectionParamsDictionary(protocolParams);
...
for ii = 1:NMeas;
    for d = 1:NDirections
        ...
        [~, ~, ~, spectroRadiometerOBJ] = OLValidateCacheFileOOC(protocolParams, ...
            ...
            'OBSERVER_AGE',                 correctionParams.observerAge, ...
            'ReducedPowerLevels',           correctionParams.reducedPowerLevels, ...
            'selectedCalType',              correctionParams.selectedCalType, ...
            ...
            'takeTemperatureMeasurements',  correctionParams.takeTemperatureMeasurements);
