        ...
        switch (meterType)
            ...
            case 'PR-670',
                ...
                spectroRadiometerOBJ.setOptions(...
                    ...
                    'sensitivityMode',  p.Results.pr670sensitivityMode, ... % choose between 'STANDARD' and 'EXTENDED'.  'STANDARD': (exposure range: 6 - 6,000 msec, 'EXTENDED': exposure range: 6 - 30,000 msec
...
cal = LoadCalFile(OLCalibrationTypes.(selectedCalType).CalFileName, [], fullfile(getpref(protocolParams.approach, 'OneLightCalDataPath')));
